...
static const char *fonts[]          = { "MesloLGSDZ Nerd FontMono:size=10", "FontAwesome:size=10" };
static const char dmenufont[]       = "MesloLGSDZ Nerd FontMono:size=10";
...
const char *spcmd2[] = {"brave", "--class=crx_jckaldkomadaenmmgladeopgmfbahfjm", "--app-id=jckaldkomadaenmmgladeopgmfbahfjm", NULL };
const char *spcmd3[] = {"pavucontrol", "--class=sppavucontrol", NULL };
const char *spcmd4[] = {"arandr", NULL };
static Sp scratchpads[] = {
  /* name                                   cmd  */
  {"spterm",                                spcmd1},
  {"crx_jckaldkomadaenmmgladeopgmfbahfjm",  spcmd2},
...
static const Rule rules[] = {
  ...
  { NULL,            "crx_jckaldkomadaenmmgladeopgmfbahfjm", NULL,            SPTAG(1),  1,          -1 },
